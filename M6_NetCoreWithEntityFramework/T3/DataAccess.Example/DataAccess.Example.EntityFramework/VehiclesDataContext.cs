...
{
    public class VehiclesDataContext : DbContext 
    {
        ...
        public virtual DbSet<VehicleIncentive> VehicleIncentives { get; set; }


        public VehiclesDataContext(DbContextOptions options) : base(options) 
        { 
